...
namespace Monkey.Cqrs
{
    ...
    {
        public ErrorCodeReason StatusCode { get; set; }
        public int ErrorCode { get; set; }
        public RequestException(ErrorCodeReason statusCode, string message, int errorCode, Exception inner=null) : base(message, inner)
        {
    ...
    [Serializable]
    public class XmlRequestException : RequestException
    {
        private readonly XDocument _document;
        public XDocument XmlMessage => _document;
        public XmlRequestException(ErrorCodeReason statusCode, XDocument document, Exception inner = null) : 
            base(statusCode, "Xml exception", 255, inner)
        {
            _document = document;
        }
    }

    public enum ErrorCodeReason
    {
        //
        // Summary:
